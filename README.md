...
**Simple name:** HiveDesk

In-browser ERP desk with AI seats (demo, not live Frappe).

This is a Grok App Builder project. The sandbox npm name was `app-builder-workspace`. On GitHub it is **S.HiveDesk** (private).
...
```bash
cd "/Users/akshitpareta/Documents/S-projects/S.HiveDesk"
npm install
npm run dev
```
